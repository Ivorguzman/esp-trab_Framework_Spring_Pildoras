...
public class SecretarioEmpleadosPrototype implements Empleados { // * Declaración de la clase SecretarioEmpleadosPrototype que implementa la interfaz Empleados
