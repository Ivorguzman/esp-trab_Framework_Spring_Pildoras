...
public class SecretarioEmpleadosSingLeton implements Empleados { // * Declaración de la clase SecretarioEmpleadosSingLeton que implementa la interfaz Empleados
