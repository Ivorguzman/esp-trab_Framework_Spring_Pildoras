...
import org.springframework.context.annotation.Scope; // * Importación de la anotación @Scope de Spring para definir el alcance del bean
...
@Scope("prototype") // * Define el alcance del bean como prototype
// @Scope("singleton")
...
public class ComercialExperimentadoPatrones implements Empleados { // * Declaración de la clase ComercialExperimentadoPatrones que implementa la interfaz Empleados
