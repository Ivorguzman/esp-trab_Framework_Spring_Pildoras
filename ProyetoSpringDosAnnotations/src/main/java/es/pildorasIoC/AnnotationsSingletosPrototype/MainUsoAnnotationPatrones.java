...
public class MainUsoAnnotationPatrones {
	...
	public static void main(String[] args) {
		...
		Empleados antonio = contextoAnnotation.getBean("comercialExperimentadoPatrones", Empleados.class);
		Empleados lucia = contextoAnnotation.getBean("comercialExperimentadoPatrones", Empleados.class);
