...
public class InformeFinancieroTriemestre2 implements CreacionInformeFinanciero { // * Declaración de la clase InformeFinancieroTrimestre2 que implementa la interfaz CreacionInformeFinanciero
